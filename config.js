...
const CONFIG = {
    ...
    enemies: {
        ...
        explosion: {
            ...
            speedMultiplier: 1.5 // Увеличиваем множитель для более заметного эффекта взрыва
        }
    },
    ...
    waves: [
        {
            killsToNext: 50,    // Количество убийств до следующей волны
            count: 5,          // Врагов одновременно на экране
            speed: 1.0,         // Скорость движения врагов
            spawnRate: 100      // Интервал для спавна
        },
        {
            killsToNext: 10,
            count: 10,
